...
rational_gcd_rel(A, B, G, C, D):- integer(A), frac_gcd_rel(A/1, B, GG, CC, DD), red_frac(GG, G), red_frac(CC, C), red_frac(DD, D), !.
rational_gcd_rel(A, B, G, C, D):- integer(B), frac_gcd_rel(A, B/1, GG, CC, DD), red_frac(GG, G), red_frac(CC, C), red_frac(DD, D), !.
rational_gcd_rel(A, B, G, C, D):- frac_gcd_rel(A, B, GG, CC, DD), red_frac(GG, G), red_frac(CC, C), red_frac(DD, D).